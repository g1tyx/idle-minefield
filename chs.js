...
var cnItems = {
    ...
    "How to Play - Player Resources": "如何玩 - 玩家资源",
    "How to Play - The Basics": "如何玩 - 基础知识",
    "Hypersonic Speed": "超音速",
    "idleMinefield is an incremental game loosely based on the puzzle game \"Minesweeper\".": "idleMinefield 是一款松散地基于益智游戏“扫雷”的增量游戏。",
    ...
    "Mine Sales": "矿山销售",
    "Mine Sweeper": "扫雷车",
    "Mines can be removed from the grid after unlocking the mine retrival upgrade. Mines can be sold for money, some groups may buy mines for more money, however selling to they might ruin your reputation.": "解锁地雷回收升级后，地雷可以从网格中移除。 矿山可以卖钱，有些团体可能会为了更多的钱买矿山，但是卖给他们可能会毁了你的声誉。",
    ...
    "Reputation is gained and lost by selling mines to various countries. Having exceptionally low or high reputation unlocks some unique upgrades.": "通过向不同国家出售矿山来获得和失去声誉。 拥有特别低或高的声誉可以解锁一些独特的升级。",
    "Resets the game automatically": "自动重置游戏",
    "Resistance to Current Vaccines": "对当前疫苗的抗性",
    "Reveals one cell every second": "每秒显示一个细胞",
